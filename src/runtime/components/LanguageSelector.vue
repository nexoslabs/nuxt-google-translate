...
<template>
  <div class="language-selector">
    <!-- Loading state -->
    <div v-if="!isLoaded" class="language-loading">
      <svg xmlns="http://www.w3.org/2000/svg" class="loading-icon" viewBox="0 0 24 24">
        <g>
          <path
    ...
    <!-- Loaded state -->
    <div v-else class="language-dropdown" @click="toggleDropdown">
      <div class="selected-language">
        <svg xmlns="http://www.w3.org/2000/svg" class="globe-icon" viewBox="0 0 24 24">
          <g>
            <path
        ...
        <svg xmlns="http://www.w3.org/2000/svg" class="chevron-icon" :class="{ 'chevron-up': isOpen }" viewBox="0 0 24 24">
      ...
      <ul v-if="isOpen" class="language-options">
        <li v-for="lang in supportedLanguages" :key="lang" :class="{ active: lang === selectedLanguage }" @click="changeLanguage(lang)">
